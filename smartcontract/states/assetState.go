...
func (assetState *AssetState)Deserialize(r io.Reader) error {
	...
	assetTypes, err := common.ReadVarBytes(r)
	if err != nil {
		return errors.New("AssetState AssetType Deserialize fail.")
	}
	assetState.AssetType = core.AssetType(assetTypes[0])
